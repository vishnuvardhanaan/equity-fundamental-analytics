-- ============================================
-- Company Score Summary View
-- ============================================
DROP VIEW IF EXISTS vw_company_score_summary;

CREATE VIEW vw_company_score_summary AS
SELECT
    symbol,
    macro_phase,
    sector,
...
-- ============================================
-- Company Strengths View
-- ============================================
DROP VIEW IF EXISTS vw_company_strengths;

CREATE VIEW vw_company_strengths AS
SELECT
    symbol,
    macro_phase,
    sector,
...
-- ============================================
-- Company Weakness View
-- ============================================
DROP VIEW IF EXISTS vw_company_weaknesses;

CREATE VIEW vw_company_weaknesses AS
SELECT
    symbol,
    macro_phase,
    sector,
...
-- ============================================
-- Company Improvement View
-- ============================================
DROP VIEW IF EXISTS vw_company_improvement_levers;

CREATE VIEW vw_company_improvement_levers AS
SELECT
    symbol,
    macro_phase,
    sector,
...
-- ============================================
-- Company Explanation View
-- ============================================
DROP VIEW IF EXISTS vw_company_explanation;

CREATE VIEW vw_company_explanation AS
WITH
    summary AS (
        SELECT
            *
